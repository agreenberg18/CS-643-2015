...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        get("/", (request, response) -> {
            ...
            messageParams.add(new BasicNameValuePair("To", "+18455585168")); // Replace with a valid phone number
            messageParams.add(new BasicNameValuePair("From", "16466933449")); // Replace with a valid phone
            // number in your account
            messageParams.add(new BasicNameValuePair("Body", "Hello from Andrew Greenberg"));
            messageFactory.create(messageParams);

            return "Hello From Andrew Greenberg";
        });
    }
}
